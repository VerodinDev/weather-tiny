...
void update_weather_view(View &view, bool data_updated)
{
    ...
    for (int i = 0; i < PERCIP_SIZE; i++)
    {
        ...
        view.percip_time[i] = ts2H(weather_request.rain[i].date_ts/*  + gmtOffset_sec */);
...
void print_reset_reason(RESET_REASON reason)
{
    ...
    {
    case 1:
        Serial.print("POWERON_RESET");
        break;
    case 3:
        Serial.print("SW_RESET");
        break;
    case 4:
        Serial.print("OWDT_RESET");
        break;
    case 5:
        Serial.print("DEEPSLEEP_RESET");
        break;
    case 6:
        Serial.print("SDIO_RESET");
        break;
    case 7:
        Serial.print("TG0WDT_SYS_RESET");
        break;
    case 8:
        Serial.print("TG1WDT_SYS_RESET");
        break;
    case 9:
        Serial.print("RTCWDT_SYS_RESET");
        break;
    case 10:
        Serial.print("INTRUSION_RESET");
        break;
    case 11:
        Serial.print("TGWDT_CPU_RESET");
        break;
    case 12:
        Serial.print("SW_CPU_RESET");
        break;
    case 13:
        Serial.print("RTCWDT_CPU_RESET");
        break;
    case 14:
        Serial.print("EXT_CPU_RESET");
        break;
    case 15:
        Serial.print("RTCWDT_BROWN_OUT_RESET");
        break;
    case 16:
        Serial.print("RTCWDT_RTC_RESET");
        break;
    default:
...
void run_validating_mode()
{
    ...
    if (connect_to_wifi())
    {
        location[0].lat = LATITUDE;
        location[0].lon = LONGITUDE;
        location_cnt = 1;
...
void setup()
{
    ...
    else if (mode == OPERATING_MODE)
    {
        ...
        // TODO make this run not so often. Once a day?
